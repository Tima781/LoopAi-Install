...
object AiChatEngine {
  ...
  private fun formatGeneralResponse(
    ...
    return when (model) {
      AiModelType.LOOP -> {
        when {
          isGreeting -> "${modePrefix}Привет! Я **Loop** — ваш родной умный искусственный интеллект. Рад встрече! Я умею отвечать на любые вопросы, решать задачи, писать код, генерировать идеи, тексты и видео. Чем могу помочь прямо сейчас?"
          isWhoAreYou -> "${modePrefix}Я **Loop** — умный искусственный интеллект, созданный специально для этого приложения! ✨\n\nМои главные возможности:\n• 🧠 **Любые вопросы**: даю исчерпывающие ответы на любые темы (наука, история, философия, быт, технологии)\n• 🧮 **Математика и логика**: решаю примеры, уравнения и задачи по шагам\n• 💻 **Программирование**: пишу и анализирую код на Python, Kotlin, JS и др.\n• 🎨 **Креатив и тексты**: сочиняю стихи, статьи, эссе, сценарии\n• 🎬 **Генерация видео**: умею анимировать сцены и персонажей с озвучкой!"
